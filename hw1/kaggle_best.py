...
for k in range (0, iteration, 1):
   ...
   if k >= 0:
      ...
      print "PM10     :",w_PM10
      print "PM25     :",w_PM25
      print "RAINFALL :",w_RAINFALL
      print "diff_PM25:",diff_PM25
      print "RH       :",w_RH
      print "SO2      :",w_SO2
      print "THC      :",w_THC
      print "WDHR     :",w_WDHR
      print "WINDDIREC:",w_WINDDIREC
      print "WINDSPEED:",w_WINDSPEED
      print "WSHR     :",w_WSHR

      print "PM10_poly:",w_PM10_poly
      print "PM25_poly:",w_PM25_poly
  
      print "PM10_poly_diff:",diff_PM10_poly
      print "PM25_poly_diff:",diff_PM25_poly
